...
def call_llm_summary(compressed_text: str, video_name: str = "") -> str:
    system_prompt = (
        ...
        "data mentah berisi catatan setiap karyawan yang terpantau di area kerja: "
        ...
        "'frame', 'track_id', atau data mentah lainnya "
        "Fokus laporan pada:\n"
        "- Ringkasan umum: jelaskan secara lengkap apa aktivitas yang dilakukan oleh pegawai.\n"
        "- Jika ada indikasi pelanggaran, jelaskan dengan jelas: karyawan mana, jenis "
        "pelanggarannya apa, dan seberapa signifikan (jangan berlebihan menyimpulkan jika "
        ...
        "- Bullet list ('- ') untuk poin-poin per karyawan atau temuan penting.\n"
        ...
        "2. ### Temuan per Karyawan (bila lebih dari satu karyawan).\n"
        "3. ### Rekomendasi.\n"
